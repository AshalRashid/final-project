        ...
        <div className="Navbar relative z-50">
            ...
            >
                    ...
                    <li className="list-none">
                        <Link
                            ...
                            className={`text-2xl text-center ml-0 md:ml-40 font-bold tracking-wide 
                                 ...
                                 md:text-white ${scrolled ? 'text-black' : 'text-white'}`}
                ...
                <div className="flex items-center gap-6 text-2xl">
                    {/* Search (button) */}
                    <button className={`${scrolled ? 'lg:text-black' : 'lg:text-white text-white'} md:text-black`}>
                        <CiSearch />
                    </button>


                    <Link to="/contact" className={`${scrolled ? 'text-black' : 'md:text-white text-white'} sm:text-black`}>
                        <IoPersonOutline />
                    </Link>

                    <button className={`${scrolled ? 'text-black' : 'md:text-white text-white'} sm:text-black`}>
                        <IoMdHeartHalf />
                    </button>

                    <Link to="/shop" className={`${scrolled ? 'text-black' : 'md:text-white text-white'} sm:text-black`}>
                        <IoBagOutline />
                    </Link>
                </div>
            </nav>
